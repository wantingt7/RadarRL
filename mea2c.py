...
def get_args():
    ...
    parser.add_argument('--logdir', type=str, default='log_temp/test7/mea2c_702')
    parser.add_argument('--logname_fic', type=str, default='mea2c_fic')
    parser.add_argument('--logname_temp', type=str, default='mea2c_temp')
    parser.add_argument('--logname_real', type=str, default='mea2c_real')
...
def main():
    ...
    for epoch1 in range(args.outer_epoch_num):
        ...
        _, test_result = onpolicy_trainer(
            policy, train_collector_fic, test_collector_fic, inner_epoch_num,
