...
def get_args():
    ...
    parser.add_argument('--logdir', type=str, default='log_temp/test4_me/medqn_pretrain')
    ...
    parser.add_argument('--pretrain_batch_num', type=int, default=50)
    parser.add_argument('--pretrain_epoch_num', type=int, default=10)
    parser.add_argument('--pretrain_id_list', type=int, default=[0, 1])
...
def main():
    ...
    env_model.update_network(pretrain_collector_real, args.pretrain_batch_size, args.pretrain_batch_num, args.pretrain_epoch_num, id_list = args.pretrain_id_list)
    ...
    for epoch1 in range(args.outer_epoch_num):
        ...
        env_model.net_selection(test_collector, args.test_data_size)
        ...
        _, test_result = offpolicy_trainer(
            ...
            save_checkpoint_fn=save_checkpoint_fn,  resume_from_log = False, logger=logger_temp)
